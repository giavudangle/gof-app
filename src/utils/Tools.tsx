...
export const OpenURL = ({ url, children } : IUrl) => {
...
export const predictTimeoutPromise = (url : Promise<any>) => {
...
export const _pickImage = async (action : any) => {
  try {
...
export const colorCheck = (colorCode : string) => {
  switch (colorCode) {
    case "yellow":
...
export const getCreditCardToken = async (creditCardData : any) => {
  const card = {
