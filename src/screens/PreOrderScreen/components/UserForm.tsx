...
const User = ({setDelivery, checkValidation } : any) => {
  return (
    <View>
      <View style={styles.container}>
        ...
        <View style={styles.inputContainer}>
          <Field
            ...
            onChangeText={(value: any) => setDelivery('name',value)}
          ...
          <Field
            ...
            label='Số Điện Thoại'
            component={renderField}
            onChangeText={(value: any) => setDelivery('phone',value)}
          ...
          <Field
            ...
            label='Địa Chỉ'
            component={renderField}
            onChangeText={(value: any) => setDelivery('address',value)}
            keyboardType='default'
            checkValidation={checkValidation}
          />
        </View>
