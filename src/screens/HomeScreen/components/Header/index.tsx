...
export const Header = ({ style,navigation,products } : IHeader) => {
  ...
  // Search Function
  const searchFilter = (searchTxt : string) => {
    const data = products.filter((product : IProduct) =>
          ...
          <View style={styles.header_inner}>
            ...
            <View>
              <Image
                ...
                style={{
                  width: height < 668 ? 50 : 50, // set size icon
                  resizeMode: 'contain',
                  padding:10
                }}
              />
